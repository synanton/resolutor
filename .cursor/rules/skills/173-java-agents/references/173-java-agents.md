...
Options:
- Build and verify: `./gradlew clean verify` or equivalent
- Deploy or install: `./gradlew clean install` or equivalent
...
Options:
- **Always do**: Key practices (e.g., edit XML sources, run `./gradlew clean verify` before promoting)
